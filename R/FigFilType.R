...
figtype <- function(outfile='', width=3*595, height=3*595, res=3*72, pointsizePDF=11,
  ...
  OffBlaaAlle <- rgb(red=c(198, 107, 66, 33, 8, 0), green=c(219, 174, 146, 113, 69, 0), #rev(
  ...
  UtFarger <- switch(fargepalett,
                     ...
                     #BlaaOff = OffBlaaAlle[c(2,3,5,6)],	"#084594" "#2171B5" "#6BAED6" "#C6DBEF" 	#Velger farge nummer 1,2,4 og 5
                     BlaaOff = OffAlleFarger[rev(c(1,2,4,5))],
                     BlaaOffAlle = OffAlleFarger[6:1],
                     StotteOff = OffAlleFarger[7:11],
                     #rgb(red=c(255,77,115,166,204), green=c(114,77,115,166,204),
